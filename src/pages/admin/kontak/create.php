...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/admin/kontak/store" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="container">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <textarea name="alamat" class="form-control mb-2" placeholder="Alamat Lengkap Perusahaan" rows="5"></textarea>
                                        </div>
                                        <div class="col-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="text" name="jam_operasional_normal" class="form-control mb-2" placeholder="Hari & Jam Operasional">
                                            <input type="text" name="jam_operasional_libur" class="form-control" placeholder="Hari Libur">
                                        </div>
                                        <div class="col-6">
                                            <small class="text-muted">
                                                <b>Contoh Pengisian Data Kontak :</b><br>
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="customer_service_nama" class="form-control mb-2" placeholder="Nama Kontak">
                                            <input type="text" name="customer_service_nomor" class="form-control mb-2" placeholder="Nomor Kontak">
                                            <input type="text" name="customer_service_email" class="form-control" placeholder="Email Kontak">
                                        </div>
                                        <div class="col-6">
                                            <label for="">Technical Support</label>
                                            <input type="text" name="technical_support_nama" class="form-control mb-2" placeholder="Nama Kontak">
                                            <input type="text" name="technical_support_nomor" class="form-control mb-2" placeholder="Nomor Kontak">
                                            <input type="text" name="technical_support_email" class="form-control" placeholder="Email Kontak">
                                        </div>
                                    </div>
                                </div>
                                <div class="row my-4">
