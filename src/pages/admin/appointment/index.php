...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Appointment <a href="/admin/appointment-approval/create" class="btn btn-sm btn-outline-primary">Add New</a></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Appointment</a></li>
                        <li class="breadcrumb-item active">Kelola Appointment</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <tbody>
                            <?php foreach ($datas->items as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-info" href="/admin/appointment-approval/<?= $value['id_appointment'] ?>/edit">Edit</a>
...
<script>
    $('#modal_konfirmasi_hapus').on('show.bs.modal', function(event) {
        ...
        var modal = $(this)
        modal.find('#form_hapus').attr('action', '/admin/appointment-approval/' + id + '/delete')
    })
</script>
