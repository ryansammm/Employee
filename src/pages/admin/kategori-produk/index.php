...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Kategori Produk <a href="/admin/kategori-produk/konten/create" class="btn btn-sm btn-outline-primary">Add New</a></h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            <?php foreach ($data_kategori_produk->items as $key => $value) { ?>
                                <tr>
                                    <td><?= $key + 1 ?></td>
                                    <td><?= $value['nama_kategori_produk'] ?></td>
                                    <td>
                                        <a class="btn btn-sm btn-info" href="/admin/kategori-produk/konten/<?= $value['id_kategori_produk'] ?>/edit">Edit</a>
                                        <a href="#" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modal_konfirmasi_hapus_kategori_produk" data-id="<?= $value['id_kategori_produk'] ?>">hapus</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
...
<script>
    $('#modal_konfirmasi_hapus_kategori_produk').on('show.bs.modal', function(event) {
        ...
        var modal = $(this)
        modal.find('#form_hapus').prop('action', '/admin/kategori-produk/konten/' + id + '/delete')
    })
</script>
