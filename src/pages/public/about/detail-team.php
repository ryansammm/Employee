                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class=" justify-content-between align-items-center mb-3">
                                <h4 style=" border-left: 5px solid #fe4d01;padding-left: 15px;font-weight: bold;">Ryan Samsudin</h4>
                                <hr>
                            </div>
                            <div class="description">
                                <div class="row">
                                    <table class="ms-2" style="width:100%;font-size: 14px;">
                                        <!-- <tr>
                                            <td>Nama</td>
                                            <td>:</td>
                                            <td>Ryan Samsudin</td>
                                        ...
                                        <tr>
                                            <td>Alamat</td>
                                            <td>:</td>
                                            <td>Jl. Talun No.18 RT.01/RW.06, Kel. Talun, Kec. Sumedang Utara, Kab. Sumedang</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
