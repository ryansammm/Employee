...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit Data Appointment</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/admin/appointment-approval/<?= $detail['id_appointment'] ?>/update" method="POST" enctype="multipart/form-data">
