...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Kelola Halaman <a href="/admin/halaman/create" class="btn btn-sm btn-outline-primary">Add New</a></h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            <?php foreach ($datas->items as $key => $value) { ?>
                                <tr>
                                    <td><?= $key + 1 ?></td>
                                    <td><?= $value['cms_halaman'] ?></td>
                                    <td>
                                        <a class="btn btn-sm btn-info me-2" href="/admin/halaman/<?= $value['id_cms_halaman'] ?>/edit">Edit</a>
                                        <a href="#" class="btn btn-sm btn-warning m-2" data-toggle="modal" data-target="#modal_konfirmasi_hapus" data-id="<?= $value['id_cms_halaman'] ?>">hapus</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
...
<script>
    $('#modal_konfirmasi_hapus').on('show.bs.modal', function(event) {
        ...
        var modal = $(this)
        modal.find('#form_hapus').attr('action', '/admin/halaman/' + id + '/delete')
    })
</script>
