...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Tambah Data Halaman</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/admin/halaman/store" method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="container mt-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="cms_halaman" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="card row-content">
                                        <div class="card-header">
                                            <h3 class="card-title">Baris ke-1</h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="row[1][cms_row_col]" class="form-control cms_row_col" required>
                                                            <option value=""> -- Pilih Kolom -- </option>
                                                            <?php for ($i = 1; $i <= 12; $i++) { ?>
                                                                <?php if (12 % $i == 0) { ?>
                                                                    <option value="<?= $i ?>" <?= $i == 1 ? 'selected' : '' ?>>1 Baris <?= $i ?> kolom</option>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-1">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="row[1][cms_row_order]" min="1" class="form-control" value="1" required>
                                                    </div>
                                                </div>
                                                <div class="col-2">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="d-inline mr-2">
                                                            <input type="radio" name="row[1][cms_row_hide]" value="1" required> Ya
                                                        </div>
                                                        <input type="radio" name="row[1][cms_row_hide]" value="2" required checked> Tidak
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="d-inline mr-2">
                                                            <input type="radio" name="row[1][cms_row_container]" value="1" required> Ya
                                                        </div>
                                                        <input type="radio" name="row[1][cms_row_container]" value="2" required checked> Tidak
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            ...
                                                                            <select name="row[1][column][1][id_cms_component]" class="form-control" required>
                                                                                <option value=""> -- Pilih Komponen -- </option>
                                                                                <?php foreach ($component->items as $key => $data) { ?>
                                                                                    <option value="<?= $data['id_cms_component'] ?>"><?= $data['cms_component'] ?></option>
                                                                                <?php } ?>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-1">
                                                                            <label for="" class="font-weight-normal">Urutan</label>
                                                                            <input type="number" name="row[1][column][1][cms_col_order]" class="form-control" value="1" required>
                                                                        </div>
                                                                        <div class="col-2">
                                                                            <div class="mb-3">
                                                                                <label for="" class="d-block font-weight-normal">Sembunyikan kolom</label>
                                                                                <div class="d-inline mr-2">
                                                                                    <input type="radio" name="row[1][column][1][cms_col_hide]" value="1" required> Ya
                                                                                </div>
                                                                                <input type="radio" name="row[1][column][1][cms_col_hide]" value="2" required checked> Tidak
                                                                            </div>
                                                                        </div>
                                                                        <div class="col">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <div class="d-inline mr-2">
                                                                                    <input type="radio" name="row[1][column][1][cms_col_container]" value="1" required> Ya
                                                                                </div>
                                                                                <input type="radio" name="row[1][column][1][cms_col_container]" value="2" required checked> Tidak
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<script>
    $(document).ready(function() {
        ...
        var form_row_elem_list = new function() {
            this.row_count = 1,
                this.generate = function() {
                    ...
                    elem += '</select></div></div><div class="col-1"><div class="mb-3"><label for="">Urutan</label><input type="number" name="row[' + this.row_count + '][cms_row_order]" min="1" class="form-control" value="' + this.row_count + '" required></div></div><div class="col-2"><div class="mb-3"><label for="" class="d-block">Sembunyikan baris</label><div class="d-inline mr-2"><input type="radio" name="row[' + this.row_count + '][cms_row_hide]" value="1" required> Ya</div><input type="radio" name="row[' + this.row_count + '][cms_row_hide]" value="2" required checked> Tidak</div></div><div class="col"><div class="mb-3"><label for="" class="d-block">Menggunakan Container?</label><div class="d-inline mr-2"><input type="radio" name="row[' + this.row_count + '][cms_row_container]" value="1" required> Ya</div><input type="radio" name="row[' + this.row_count + '][cms_row_container]" value="2" required checked> Tidak</div></div><!-- form row -->'
        ...
        var form_column_elem_list = new function() {
            this.row_count = 1,
                ...
                this.generate = function() {
                    ...
                    elem += '</select></div><div class="col-1"><label for="" class="font-weight-normal">Urutan</label><input type="number" name="row[' + this.row_count + '][column][' + this.column_count + '][cms_col_order]" class="form-control" value="' + this.column_count + '" required></div><div class="col-2"><div class="mb-3"><label for="" class="d-block font-weight-normal">Sembunyikan kolom</label><div class="d-inline mr-2"><input type="radio" name="row[' + this.row_count + '][column][' + this.column_count + '][cms_col_hide]" value="1" required> Ya</div><input type="radio" name="row[' + this.row_count + '][column][' + this.column_count + '][cms_col_hide]" value="2" required checked> Tidak</div></div><div class="col"><div class="mb-3"><label for="" class="d-block font-weight-normal">Menggunakan Container?</label><div class="d-inline mr-2"><input type="radio" name="row[' + this.row_count + '][column][' + this.column_count + '][cms_col_container]" value="1" required> Ya</div><input type="radio" name="row[' + this.row_count + '][column][' + this.column_count + '][cms_col_container]" value="2" required checked> Tidak</div></div></div></div></div></div><!-- form column -->'
        ...
        $(document).on('change', '.cms_row_col', function() {
            ...
            form_column_elem_list_obj.column_count = 1;
        })
    });
</script>
