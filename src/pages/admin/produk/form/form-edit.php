        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-4">
                            <img src="/assets/media/<?= $produk['path_media'] ?>" class="img-fluid img-thumbnail produk_foto_utama_preview">
                        </div>
                        <div class="col">
                            <label for="produk_foto" class="form-label">Foto Produk Utama</label> (.jpg, .jpeg, .png)
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input produk_foto_utama" id="customFile" name="produk_foto_utama">
                                    <label class="custom-file-label" for="customFile">Choose file</label>
                                    <input type="hidden" name="produk_foto_utama_temp" class="produk_foto_utama_temp">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row listFormFoto">
                        <?php foreach ($foto_produk_lainnya->items as $key => $value) {
                            ...
                            <div class="col-2 listfoto pt-3" id="listfoto_<?= $keyForElement ?>">
                                ...
                                <input type="hidden" name="foto_produk_lainnya_temp_<?= $value['id_media'] ?>" class="foto_produk_lainnya_temp">
                                <?php if ($key != 0) { ?>
