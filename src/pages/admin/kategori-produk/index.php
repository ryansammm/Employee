...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Kategori Produk <a href="/admin/kategori-produk/create" class="btn btn-sm btn-outline-primary">Add New</a></h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <tbody>
                            <?php foreach ($data_kategori_produk->items as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-info" href="/admin/kategori-produk/<?= $value['id_kategori_produk'] ?>/edit">Edit</a>
...
<script>
    $('#modal_konfirmasi_hapus_kategori_produk').on('show.bs.modal', function(event) {
        ...
        var modal = $(this)
        modal.find('#form_hapus').prop('action', '/admin/kategori-produk/' + id + '/delete')
    })
</script>
