...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container">
            <form action="/admin/bidang/<?= arr_offset($detail, 'id_bidang') ?>/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_bidang" name="nama_bidang" value="<?= arr_offset($detail, 'nama_bidang') ?>">
                                </div>
                            </div>
                        </div>
