...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Kelola Tampilan Kategori Layanan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Layanan</a></li>
                        <li class="breadcrumb-item"><a href="#">Kelola Kategori</a></li>
                        <li class="breadcrumb-item">Kelola Tampilan Kategori Layanan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/admin/kategori-layanan/style/update" method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_fonts_store" action="/admin/fonts/store" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="redirect_to" value="/admin/kategori-layanan/style">
                </form>
            </div>
