...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/admin/video/store" method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <!------- Judul Video ------->
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control input-message" rows="3" name="keterangan_video"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
