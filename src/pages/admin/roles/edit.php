...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/admin/roles/<?= $roles['id_role'] ?>/update" method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_role" name="nama_role" value="<?= $roles['nama_role'] ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="alias_role" class="form-label">Alias Role</label>
                                    <input type="text" class="form-control" id="alias_role" name="alias_role" value="<?= $roles['alias_role'] ?>">
                                </div>
                            </div>
                        </div>
                    </div>
