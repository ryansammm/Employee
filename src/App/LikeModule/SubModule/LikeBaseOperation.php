...
use App\LikeModule\LikeModuleOperation;

class LikeBaseOperation implements LikeModuleOperation
{
    private $id_berita;
    private $id_user;
    private $likeBerita;
    ...
    {
        $get_berita = $this->getModelContent();
     ...
     * @param string $type: 1 for like, 2 for dislike
     */
    public function deleteLike(string $type = '1')
    {
        return $this->likeBerita
            ->where('id_berita', $this->id_berita)
            ->where('id_user', $this->id_user)
