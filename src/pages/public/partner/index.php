    ...
    <div class="row mt-4">
        <div class="card" style="background-color: unset;border: unset;">
            ...
            <div class="card-body" style="padding: 10px 0 0 0;">
                <div class="row">
                    <?php foreach ($data_partner->items as $key => $value) { ?>
                        <div class="col-md-2 col-4 mb-3">
                            <div class="card">
                                <div class="card-body" style="padding: 1rem">
                                    <a href="/partner/<?= $value['id_partner'] ?>/detail">
                                        <div class="img-video" style="background: url('/assets/media/<?= $value['path_media'] ?>');background-size: 70%;background-position:  center;border-radius: 0.25rem;background-repeat: no-repeat;">
                                        </div>
                                    </a>
                                </div>
                            </div>
