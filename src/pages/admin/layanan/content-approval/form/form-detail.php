...
<?php if ($layanan['status_layanan'] == '3') { ?>
<?= template('admin/layanan/content-approval/form/form-approval', [
    'layanan' => $layanan
]) ?>
<?php } ?>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">Pratinjau Gambar</h6>
