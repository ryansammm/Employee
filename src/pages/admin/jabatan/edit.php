...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/admin/jabatan/<?= arr_offset($detail, 'id_jabatan') ?>/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama" value="<?= arr_offset($detail, 'nama') ?>">
                                </div>
                                <div class="row my-4">
