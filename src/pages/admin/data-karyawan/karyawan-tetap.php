                        ...
                        <tbody>
                            <?php foreach ($datas->items as $key => $value) { ?>
                                <tr>
                                    <td><?= $key + 1 ?></td>
                                    <td>
                                        <a href="http://employee.demo1.tristek.co.id/employee/<?= $value['karyawan_identitas'] ?>/detail" target="_balcnk"><?= $value['nama_lengkap'] ?></a>
                                    </td>
                                    ...
                                    <td>
                                        <a href="http://employee.demo1.tristek.co.id/employee/<?= $value['karyawan_identitas'] ?>/detail" class="btn btn-sm btn-outline-success my-1" data-toggle="tooltip" data-placement="bottom" title="Pratinjau" target="_blank"><i class="fa fa-eye"></i></a>
                                        <a class=" btn btn-sm btn-outline-primary my-1" href="/admin/karyawan/<?= $value['karyawan_identitas'] ?>/edit" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
