...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Approval Layanan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Layanan</a></li>
                        <li class="breadcrumb-item active">Approval Layanan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <tbody>
                            <?php foreach ($data_layanan->items as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td><h6><span class="badge badge-<?= $value['status_layanan'] == '1' ? 'success' : 'secondary' ?>"><?= $value['status_layanan'] == '1' ? 'Publish' : 'Draft' ?></span></h6></td>
                                    <td>
                                        <a class="btn btn-sm btn-info" href="/admin/layanan/<?= $value['id_layanan'] ?>/detail">Detail</a>
                                        <?php if ($value['status_layanan'] == '2') { ?>
