...
$routes->prefix('admin', function ($routes) {
    ...
    $routes->prefix('produk', function ($routes) {
        ...
        $routes->push('produk_approval_action', '/approval/{id}/action/{status}', [ProdukAdminController::class, 'approval_action']);
        $routes->push('produk_approval_detail', '/approval/{id}/detail', [ProdukAdminController::class, 'approval_detail']);
    });
    /* -------------------------------------------------------------------------- */
