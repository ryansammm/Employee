                ...
                <?php foreach ($data_produk->items as $key => $value) { ?>
                    <div class="col-md-4">
                        <div class="card shadow-sm">
                            <a class="text-decoration-none" href="/product/<?= $value['id_produk'] ?>/detail">
                            ...
                            <div class="card-body">
                                <a class="text-decoration-none" href="/product/<?= $value['id_produk'] ?>/detail">
                                    <h6 class="truncate-string-1" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= $value['nama_produk'] ?>"><?= $value['nama_produk'] ?></h6>
