                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3 ms-3">
                            <h4 style="border-left: 5px solid #fe4d01;padding-left: 15px;font-weight: bold;"><?= $detail['nama_akreditasi'] ?></h4>
                        </div>
                        <hr>
                        ...
                        <div class="mt-3">
                            <p class="px-3" style="font-size: 14px;"><?= $detail['deskripsi_akreditasi'] ?></p>
                        </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel"><?= $detail['nama_akreditasi'] ?></h5>
