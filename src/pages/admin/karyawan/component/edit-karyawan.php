<ul class="nav nav-tabs" id="myTab" role="tablist" style="font-size: 11px !important;">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="sebelum-bergabung" role="tabpanel" aria-labelledby="sebelum-bergabung-tab">
                    ...
                    <div class="container-fluid">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="no_induk_karyawan" maxlength="16" class="form-control" value="<?= $detail['no_induk_karyawan'] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <div class="mb-0">
                                ...
                                <?php foreach ($pendidikan_formal->items as $key => $value) { ?>
                                    <div class="col-12 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="tahun_pendidikan[]" class="form-control mt-2" maxlength="4" placeholder="Tahun Lulus" value="<?= $value['tahun_lulus'] ?>">
                                    ...
                                    <div class="row mt-2 multi-input-item2">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" min="1" name="tahun_nonformal[]" class="form-control" value="<?= $value['periode_tahun'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="mb-3">
                        ...
                        <button type="button" class="mt-2 btn btn-sm btn-success multi-input-add3">Tambah Kolom</button>
                        <!-- END KEMAMPUAN -->
                        ...
                        <div class="border p-3 rounded">
                            <div class="mb-3">
                                <textarea class="form-control" name="karakter" id="" cols="30"><?= $detail['karakter'] ?></textarea>
                            </div>
                        </div>
                        <!------- End Karakter ------->
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nama_kontak_alt" value="<?= $karyawan_kontak_alt['nama_kontak_alt'] ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Hubungan Keluarga</label>
                                        <input type="text" class="form-control" name="hubungan_keluarga_kontak_alt" value="<?= $karyawan_kontak_alt['hubungan_keluarga_kontak_alt'] ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Alamat Lengkap</label>
                                        <textarea name="alamat_kontak_alt" class="form-control"><?= $karyawan_kontak_alt['alamat_kontak_alt'] ?></textarea>
                                        <input type="text" name="kode_pos_kontak_alt" class="form-control mt-2" placeholder="Kode POS" value="<?= $karyawan_kontak_alt['kode_pos_kontak_alt'] ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        <label for="">Nomor Seluler Kerluarga</label>
                                        <input type="text" name="no_telp_kontak_alt" class="form-control number" value="<?= $karyawan_kontak_alt['no_telp_kontak_alt'] ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="mb-3">
                                        <label for="">Alamat E-mail Keluarga</label>
                                        <input type="email" name="email_kontak_alt" class="form-control" value="<?= $karyawan_kontak_alt['email_kontak_alt'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="button" class="btn btn-sm btn-success mt-2 multi-input-add">Tambah Kolom</button>
                        ...
                        <button type="button" class="btn btn-sm mt-2 btn-success multi-input-add1">Tambah Kolom</button>
                    </div>
                </div>
                            ...
                            <?php if (empty($pendidikan_non_formal_bergabung->items)) { ?>
                                <div class="row mt-2 multi-input-item4">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="mb-3">
                                            <label for="">Periode Tahun</label>
                                            <input type="text" min="1" name="tahun_nonformal_setelah[]" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="mb-3">
                                ...
                                <?php foreach ($pendidikan_non_formal_bergabung->items as $key => $value) { ?>
                                    <div class="row mt-2 multi-input-item4">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="mb-3">
                                                <label for="">Periode Tahun</label>
                                                <input type="text" min="1" name="tahun_nonformal_setelah[]" class="form-control" value="<?= $value['periode_tahun'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="mb-3">
...
<script>
    $(function() {
        ...
        $('.multi-input-add5').on('click', function() {
            ...
            item5.append('<div class="col-12"><button type="button" class="btn btn-sm btn-danger mt-1 multi-input-delete5">Hapus Kolom</button></div>');
