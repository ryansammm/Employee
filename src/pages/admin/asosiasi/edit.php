...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit Data Asosiasi</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/admin/asosiasi/<?= arr_offset($detail, 'id_asosiasi') ?>/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_asosiasi" name="nama_asosiasi" value="<?= arr_offset($detail, 'nama_asosiasi') ?>">
                                </div>
                                <div class="mb-3">
                                    <div class="row">
