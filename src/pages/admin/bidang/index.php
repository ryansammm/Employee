            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li>
                            <a href="/admin/bidang/create" class="btn btn-sm btn-outline-primary py-2 ml-2">
                        ...
                        <tbody>
                            <?php foreach ($datas->items as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-outline-primary my-1" href="/admin/bidang/<?= $value['id_bidang'] ?>/edit">Edit</a>
                                        <a href="#" class="btn btn-sm btn-outline-warning my-1" data-toggle="modal" data-target="#modal_konfirmasi_hapus" data-id="<?= $value['id_bidang'] ?>">hapus</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
...
<script>
    $('#modal_konfirmasi_hapus').on('show.bs.modal', function(event) {
        ...
        var modal = $(this)
        modal.find('#form_hapus').attr('action', '/admin/bidang/' + id + '/delete')
    })
</script>
