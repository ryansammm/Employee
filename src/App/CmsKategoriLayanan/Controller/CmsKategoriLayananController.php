...
namespace App\CmsKategoriLayanan\Controller;
...
class CmsKategoriLayananController
{
    ...
    public function __construct()
    {
        ...
        $this->cms_jenis_kategori = 'layanan-kami';
    }
    ...
    public function edit(Request $request)
    {
        ...
        return render_template('admin/cms-kategori-layanan/edit', compact('detail', 'fonts'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return new RedirectResponse('/admin/kategori-layanan/style');
    }
}
